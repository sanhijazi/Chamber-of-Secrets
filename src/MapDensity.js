...
function MapDensity({ data, width, height, margin }) {
    ...
    return (
        <Container>
            ...
            <Text style={{ fontSize: '15px', fontWeight: '300' }}>
                Explore the global distribution of CO₂ emission density (CO₂ per Km²) per decade, visualized through an Stereo graphic Projection Map. 
