...
function MapAzimuthal({ data, width, height, margin }) {
    ...
    useEffect(() => {
        ...
        // Set up the azimuthal equal-area projection
        const projection = d3.geoAzimuthalEqualArea()
            .scale(200)
            .translate([innerWidth / 2, innerHeight / 2])
            .rotate([0, 0]); // adjust rotation if needed
    ...
    return (
        <Container>
            ...
            <Text style={{ fontSize: '15px', fontWeight: '300' }}>
                Explore the global distribution of total emissions per capita, visualized through an Azimuthal Projection Map. 
                This projection offers a unique view, emphasizing spatial relationships and emissions trends across the world.
            </Text>
                <svg ref={svgRef}></svg>
            </Flex>
            <LeftContainer>
